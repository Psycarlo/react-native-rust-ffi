...
var _NativeRustFfi = _interopRequireDefault(require("./NativeRustFfi.js"));
var rust_ffi = _interopRequireWildcard(require("./generated/rust_ffi.js"));
Object.keys(rust_ffi).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === rust_ffi[key]) return;
...
if (!rustInstalled) {
  _NativeRustFfi.default.installRustCrate();
  rustInstalled = true;
}
